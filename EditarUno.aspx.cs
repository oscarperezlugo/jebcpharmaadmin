...
{
    public partial class EditarUno : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string vendedor = GridView2.Rows[i].Cells[4].Text; //
                string row = GridView2.Rows[i].Cells[5].Text;
                string rif = GridView2.Rows[i].Cells[6].Text;
                string sicm = GridView2.Rows[i].Cells[7].Text;
                string tel2 = GridView2.Rows[i].Cells[8].Text;
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EditarUno.aspx");
        }
    }
}