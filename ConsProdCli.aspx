<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsProdCli.aspx.cs" Inherits="PanelAdmin.ConsProdCli" %>
        ...
        <div class="card-body">
                <div class="form-row">                        
                    <table style="width: 100%;">
                        ...
                        <tr>--%>
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="SELECCIONE EL PRODUCTO" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
