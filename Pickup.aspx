...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="PEDIDOS RETIRO" Style="font-weight: bold; font-size: 18px;"></asp:Label>                                                
                    </div>                   
                </div>
            </div>
        <div class="card-body">
...
<PagerStyle CssClass="pgr"></PagerStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT * FROM [Cabecera] WHERE ([TipoVenta] = @TipoVenta) AND [Status] = 'VERIFICADO' ORDER BY [FechaVenta] DESC">
        <SelectParameters>
            <asp:Parameter DefaultValue="PICKUP" Name="TipoVenta" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</div>
            </div>
