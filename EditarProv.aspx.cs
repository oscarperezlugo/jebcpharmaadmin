...
{
    public partial class EditarProv : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (GridView1.SelectedIndex >= 0)
            {
                ...
                string correo = GridView1.Rows[i].Cells[1].Text;
                //string correo = GridView1.Rows[i].Cells[2].Text;
                string telefono = GridView1.Rows[i].Cells[2].Text;
                string direccion = GridView1.Rows[i].Cells[3].Text;
                ...
                //HttpCookie fechaS = new HttpCookie("vendedorC");
                //fechaS.Value = vendedor;
                ...
                Response.Redirect("ProveedorEditar.aspx");
            }
            else
            {
                int i = GridView2.SelectedIndex;
                string nombre = GridView2.Rows[i].Cells[0].Text;
                string correo = GridView2.Rows[i].Cells[1].Text;
                //string correo = GridView1.Rows[i].Cells[2].Text;
                string telefono = GridView2.Rows[i].Cells[2].Text;
                string direccion = GridView2.Rows[i].Cells[3].Text;
                //string vendedor = GridView1.Rows[i].Cells[4].Text; //
                string row = GridView2.Rows[i].Cells[4].Text;
                string rif = GridView2.Rows[i].Cells[5].Text;
                //string sicm = GridView1.Rows[i].Cells[7].Text;
                //string tel2 = GridView1.Rows[i].Cells[8].Text;
                //string tipo = GridView1.Rows[i].Cells[9].Text; //
                string pers = GridView2.Rows[i].Cells[6].Text;  //          
                HttpCookie nombreS = new HttpCookie("nombreProvC");
                nombreS.Value = nombre;
                nombreS.Expires = DateTime.Now.AddDays(1);
                Response.Cookies.Add(nombreS);
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EditarProv.aspx");
        }
    }
}