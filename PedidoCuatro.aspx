<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoCuatro.aspx.cs" Inherits="PanelAdmin.PedidoCuatro" %>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td><asp:Label ID="Label5" runat="server" CssClass="formularioFinD" ></asp:Label>
                                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="formularioblockD"   AppendDataBoundItems="true" DataTextField="PrecioCompra" DataValueField="PrecioCompra"  AutoPostBack="true">                                
                                </asp:DropDownList>
                                </td>
