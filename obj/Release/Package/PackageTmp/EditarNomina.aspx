...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT [Nombre], [Correo], [Telefono], [Direccion], [FechaRegistro], [iDCliente], [Row], [Rif], [Sueldo], [sicm], [Telefono2], [TipoCliente], [Persona], Sueldo, Tipo, Apellido FROM [Clientes] WHERE ([Nombre] LIKE '%' + @Nombre + '%' AND Tipo='VENDEDOR') OR ([Nombre] LIKE '%' + @Nombre + '%' AND Tipo='ADMINISTRATIVO') OR ([Nombre] LIKE '%' + @Nombre + '%' AND Tipo='ALMACEN')">
                        <SelectParameters>
