<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoDetalleCuatro.aspx.cs" Inherits="PanelAdmin.PedidoDetalleCuatro" %>
...
<%--            <asp:BoundField DataField="Apellido" HeaderText="Apellido" SortExpression="Apellido" />--%>
    ...
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT Distinct [Nombre], [Apellido], [Correo], [Telefono] FROM [Clientes] WHERE ([iDCliente] = @iDCliente)">
        <SelectParameters>
...
<AlternatingRowStyle CssClass="alt"></AlternatingRowStyle>
        <Columns>
            <asp:BoundField DataField="FechaVenta" HeaderText="Fecha" SortExpression="FechaVenta" DataFormatString="{0:d}"/>
...
<%--            <asp:BoundField DataField="SubTotal" HeaderText="SubTotal" SortExpression="SubTotal" />--%>
            ...
            <asp:BoundField DataField="FechaPago" HeaderText="Fecha De Pago" SortExpression="FechaPago" />
...
<PagerStyle CssClass="pgr"></PagerStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT [FechaVenta], [Monto], [Lineas], [SubTotal], [Status], [TipoVenta], [Metodo], [Direccion], NroOp, FechaPago  FROM [Cabecera] WHERE ([iDVenta] = @iDVenta)">
        <SelectParameters>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" GridLines="None" AllowPaging="True" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="20" ForeColor="Black" margin-left="2%" ShowFooter="true">
        <Columns>
            ...
            <asp:BoundField DataField="FechaVenc" HeaderText="Vencimiento" SortExpression="FechaVenc" DataFormatString="{0:d}"/>
            <asp:BoundField DataField="Cantidad" HeaderText="Cantidad" SortExpression="Cantidad" />
            <asp:BoundField DataField="Precio" HeaderText="Precio" SortExpression="Precio" DataFormatString="{0:#,#}"/>
        </Columns>
        <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                            <HeaderStyle BackColor="white" Font-Bold="True" ForeColor="black" />
                            <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" />
