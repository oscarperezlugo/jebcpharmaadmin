<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientesVendedor.aspx.cs" Inherits="PanelAdmin.ClientesVendedor" %>
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT [Nombre], [Correo], [Telefono], [Direccion], [FechaRegistro], [iDCliente], [Row], [Rif], [Sueldo], [sicm], [Telefono2], [TipoCliente], [Persona], Vendedor FROM [Clientes] WHERE ([Vendedor] LIKE '%' + @Vendedor + '%') AND Tipo='CLIENTE'">
                        <SelectParameters>
                            <asp:CookieParameter CookieName="paramcincoC" Name="Vendedor" Type="String"></asp:CookieParameter>
                        </SelectParameters>
                    </asp:SqlDataSource>           
                    </div>
        </div>
